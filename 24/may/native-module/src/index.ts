...
import NativeModuleView from './NativeModuleView';
import { ChangeEventPayload, NativeModuleViewProps } from './NativeModule.types';
...
const emitter = new EventEmitter(NativeModule ?? NativeModulesProxy.NativeModule);
